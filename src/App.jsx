        ...
        <div className='bg-light w-50 shadow rounded p-5'>
          ...
          <form onSubmit={(e)=>{submitted(e)}}>
            ...
            <Stack spacing={2} direction="row">
              <Button variant="contained" disabled={validpamount&&validrate&&validtime?false:true} type='submit' className='bg-primary' style={{height:'50px',width:'50%', color:'white'}}>Submit</Button>
              <Button variant="contained" onClick={reset} className='bg-secondary' style={{height:'50px',width:'50%'}}>Reset</Button>
            </Stack>
            </div>
          </form>
        </div>
